          ...
          <div className="mx-auto flex h-16 w-full max-w-[1400px] items-center justify-between px-4 md:px-6">
            ...
            <div className="text-right">
              ...
              <div className="flex items-center justify-end gap-2">
                ...
                <button type="button" onClick={() => void signOut()} className="rounded-lg border border-zinc-200 bg-white px-2 py-1 text-xs text-zinc-600">
      ...
      <div className="mx-auto flex w-full max-w-[1400px] gap-4 px-4 pb-6 pt-4 md:px-6">
        {!isLoginRoute ? (
          <>
            ...
            {openMobile ? (
              <div className="fixed inset-0 z-30 bg-black/30 md:hidden" onClick={() => setOpenMobile(false)}>
                <aside className="admin-card m-3 w-72 p-3" onClick={(e) => e.stopPropagation()}>
                  <nav className="space-y-1">
                    {visibleTabs.map((tab) => (
                      <Link
                        key={tab.href}
